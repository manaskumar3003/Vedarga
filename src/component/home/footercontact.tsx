  ...
  <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      <div className="col-span-full lg:col-span-1">
        <a className="flex-none text-xl font-semibold text-black" href="#" aria-label="Brand">Vedarga</a>
      </div>
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          <p><a className="inline-flex gap-x-2 text-gray-800 hover:text-gray-600 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Pricing</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-800 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Tools</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-800 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Goals</a></p>
        </div>
      </div>
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          <p><a className="inline-flex gap-x-2 text-gray-800 hover:text-gray-600 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">About us</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-800 hover:text-gray-600 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Blog</a></p>
          ...
          <p><a className="inline-flex gap-x-2 text-gray-800 hover:text-gray-600 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Customers</a></p>
        </div>
      </div>
    ...
    <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-500 dark:text-neutral-400">© 2024 Vedarga. All rights reserved.</p>
      </div>
