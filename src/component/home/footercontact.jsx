    ...
    <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
      ...
      <div class="divide-y divide-gray-200 dark:divide-neutral-800">
        ...
        <div class="flex gap-x-7 py-6">
          ...
          <div class="grow">
            <h3 class="font-semibold text-gray-800 dark:text-neutral-200">community</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">We're here to help with any questions </p>
        ...
        <div class=" flex gap-x-7 py-6">
          ...
          <div class="grow">
            <h3 class="font-semibold text-gray-800 dark:text-neutral-200">Social Handle</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">Check out our latest post.</p>
            <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">
              Check Now
              <svg class="flex-shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.975821 6.92249C0.43689 6.92249 -3.50468e-07 7.34222 -3.27835e-07 7.85999C-3.05203e-07 8.37775 0.43689 8.79749 0.975821 8.79749L12.7694 8.79748L7.60447 13.7596C7.22339 14.1257 7.22339 14.7193 7.60447 15.0854C7.98555 15.4515 8.60341 15.4515 8.98449 15.0854L15.6427 8.68862C16.1191 8.23098 16.1191 7.48899 15.6427 7.03134L8.98449 0.634573C8.60341 0.268455 7.98555 0.268456 7.60447 0.634573C7.22339 1.00069 7.22339 1.59428 7.60447 1.9604L12.7694 6.92248L0.975821 6.92249Z" fill="currentColor"/>
  ...
  <div class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      <div class="col-span-full lg:col-span-1">
        <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">Vedarga</a>
      </div>
      ...
      <div class="col-span-1">
        ...
        <div class="mt-3 grid space-y-3">
          ...
          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Tools</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Goals</a></p>
        </div>
      </div>
    ...
    <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div class="flex justify-between items-center">
        <p class="text-sm text-gray-400 dark:text-neutral-400">© 2024 Vedarga. All rights reserved.</p>
      </div>
