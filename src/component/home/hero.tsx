...
<div className="bg-gradient-to-b from-violet-800 via-blue-400">
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-5">
   
    <div className="flex justify-center">
      <a className="group inline-block bg-blue-500 hover:bg-blue-600 border border-blue/10 p-1 ps-4 rounded-full shadow-md focus:outline-none focus:ring-1 focus:ring-gray-600" href="../figma.html">
    ...
    <div className="max-w-3xl text-center mx-auto">
      <p className="text-lg text-gray-800">We at vedarga provide tailored ecosystem for new startup to grow at 100X potential</p>
    </div>
...
<div className="relative bg-neutral-100 overflow-hidden">
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div className="max-w-2xl text-center mx-auto">
      ...
      <p className="mt-3 text-lg text-gray-700 dark:text-neutral-400">Build your business here. Take it anywhere.</p>
    </div>
