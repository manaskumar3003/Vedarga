...
const Fnav = () => {
  return (
    ...
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white dark:bg-neutral-800 border-b border-gray-200 text-sm py-2.5 sm:py-4 dark:bg-neutral-750 dark:border-neutral-700">
          ...
          <div className="hidden mx-auto sm:block">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                <svg className="flex-shrink-0 size-4 text-gray-500 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
              </div>
              <input type="text" id="icon" name="icon" className="py-2 px-4 ps-11 pe-20 block w-92 md:w-96 bg-gray-200 dark:bg-neutral-700 border-neutral-400 shadow-sm rounded-lg text-sm text-gray-900 focus:z-10 focus:border-gray-100 focus:ring-gray-600 placeholder:text-gray-500 dark:border-neutral-100 dark:text-neutral-500 dark:placeholder-neutral-100 dark:focus:ring-neutral-100" placeholder="Search"/>
