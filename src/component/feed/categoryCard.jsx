...
const CategoryCard = () => {
  return (
    <div><div class="max-w-[85rem] px-4 py-2 sm:px-6 lg:px-8 lg:py-4 mx-auto">

    <div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-6">
   
      <a class="group flex flex-col bg-white border shadow-sm rounded-full hover:shadow-md transition dark:bg-neutral-800 dark:border-neutral-800" href="#">
